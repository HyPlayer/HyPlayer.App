...
namespace HyPlayer.Views.Pages
{
    ...
    public sealed partial class ShellPage : Page
    {
        ...
        private string Title => MainWindow.Instance.Title; 
        private AppWindow AppWindow => MainWindow.Instance.AppWindow;
        private AppWindowTitleBar titleBar => MainWindow.Instance.AppWindow.TitleBar;
